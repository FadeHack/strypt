...
| Fixture | Defect | Expected |
|---|---|---|
| `malformed/id3-prefixed.flac` | An ID3v2 tag glued in front of the marker | Refused **by name**, not mislabelled as MP3. Reading the tag is a later tranche's job (ADR-0037) |
