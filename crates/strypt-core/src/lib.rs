...
//! corpus. Phase 2 opened on 2026-08-23 (ADR-0027); GIF is the most recent format to land, and
//! as of 2026-08-27 every shipped handler has had a clean sustained fuzz run. A format with no
